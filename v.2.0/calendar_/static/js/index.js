...
// - base_selector - параметр
{
    ...
    // по сути в джава мы бы присвоили название функции start. По смыслу было бы то же самое
    {
        ...
        //document.querySelector() - найти нужный тег по селектору this.base_selector 
        //дальше кусок кода .innerHTML="" изменяет содержимое тега на ничего, по сути удаляем содержимое
        ...
        //this. - в данном случае это аналог self. из питона или this. из джава
        //(this) - нужно для привязки к текущему обьекту из за особенностей языка джава 
        var showError = this.showError.bind(this);//то же самое с другой функцией
        this.api.getListSpecialist(showListSpecialist, showError)//вызов функции из класса api - смотри код функции в файле api
    ...
    this.showListSpecialist = function(list)//функция принимает на вход ответ сервера в виде списка специалистов
    //функция подготавливает и выводит на экране пользователя список специалистов
    {
